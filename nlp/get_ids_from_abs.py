...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Get concept ids from abst')
    parser.add_argument('--ab', type=str, help="abstract file")
    ...
    t = timeit.default_timer()
    record_umls_ids(args.ab, args.out, args.begin, args.end)
    print("\nTime took to run", timeit.default_timer() - t)